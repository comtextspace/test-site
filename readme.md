...
Инструкция по созданию сайта с книгами или архива статей на основе технологий **ComText**.
...
* Не требуется отдельный сервер: исходные тексты хранятся на GitHub, сайт размещается на GitHub Pages.  
* Возможность привязать собственный домен или использовать стандартный адрес GitHub Pages.
