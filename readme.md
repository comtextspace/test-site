...
* Возможно привязать свой домен или оставить стандартный от GitHub Pages.
...
Если к сайту нужно подключить домен то укажите его в файле `.github/workflows/deploy-site.yml`
